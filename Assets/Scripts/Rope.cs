...
public class Rope : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (lineRenderer != null)
        {
            ...
            SpringJoint2D connecnedObjectJoint = connectedObject.GetComponent<SpringJoint2D>();
            lineRenderer.SetPosition(ropeSegments.Count + 1, connectedObject.transform.TransformPoint(connecnedObjectJoint.anchor));
        }
